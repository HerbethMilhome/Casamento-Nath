  ...
  return (
    <section id="dress-code" className="py-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      <div className="max-w-5xl mx-auto relative z-10">
        ...
        <div className="glass rounded-[2rem] p-8 sm:p-12 shadow-sm border border-[#CBDDB5] mb-10">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
            
            {/* For Women */}
            <div className="flex flex-col justify-between">
              <div>
                <div className="flex items-center gap-2 text-[#608334] text-xs font-semibold uppercase tracking-[0.2em] mb-3">
                  <Sparkles size={16} />
                  <span>Para as Mulheres</span>
                </div>
                <h3 className="font-serif text-xl sm:text-2xl text-[#202D17] mb-3">
                  Vestidos fluidos, midi ou longos
                </h3>
                <p className="text-sm text-[#38452D] leading-relaxed font-light mb-4">
                  {wedding.dressCodeWomen}
                </p>
              </div>

              <div className="bg-white/60 p-4 rounded-2xl border border-[#CBDDB5] text-xs text-[#38452D] flex items-start gap-2.5">
                <Check size={16} className="text-[#608334] shrink-0 mt-0.5" />
          ...
          {wedding.dressCodeAvoid && (
            <div className="mt-10 pt-8 border-t border-[#CBDDB5]/60">
              <div className="bg-[#608334]/10 border border-[#CBDDB5] rounded-2xl p-5 flex items-start gap-3.5">
                <AlertCircle size={20} className="text-[#608334] shrink-0 mt-0.5" />
                <div>
                  <span className="font-serif text-base text-[#202D17] font-medium block mb-1">
        ...
        {wedding.dressCodeColors && wedding.dressCodeColors.length > 0 && (
          <div className="text-center">
            <span className="text-[10px] tracking-[0.2em] uppercase text-[#608334] font-semibold block mb-4">
              ...
              {wedding.dressCodeColors.map((color, idx) => (
                <div key={idx} className="flex flex-col items-center gap-2">
                  <div
                    ...
                    title={color.name}
                  />
                  <span className="text-[11px] font-medium text-[#202D17]">
                    {color.name}
                  </span>
                </div>
              ))}
